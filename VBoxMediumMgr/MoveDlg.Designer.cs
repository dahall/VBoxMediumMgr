namespace VBoxMediumMgr
{
	partial class MoveDlg
	{
		...
		private void InitializeComponent()
		{
			...
			this.groupBox1.Text = "&Hard disk to move";
			// 
			// diskOpenBtn
			// 
			...
			this.groupBox2.Text = "&New hard disk location";
			// 
			// fileTextBox
			// 
			...
			this.commandPanel.Location = new System.Drawing.Point(0, 142);
			...
			this.tableLayoutPanel2.RowStyles.Add(new System.Windows.Forms.RowStyle());
			this.tableLayoutPanel2.Size = new System.Drawing.Size(467, 142);
			...
			this.Text = "Move Virtual Hard Disk";
